<?php
  ...
  include("/xampp/htdocs/appweb/configuraciones/conexion_bd.php");
      ...
      <div id="content">
        ...
        <section>
          <div class="container text-dark">
            <form action="../horario/Registro_Horario.php" method="post">
              <div class="form-row">
        ...
        <div class="text-dark">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <td><?php echo "<a href='../horario/vista_EditarHorario.php?idHorario=".$mostrar['IDHorario']."' class='text-light btn btn-success'>Editar <i class='icon ion-md-create'></i></a> ";?></td>
                    <td><?php echo "<a href='../horario/Eliminar_Horario.php?idHorario=".$mostrar['IDHorario']."' onclick='return confirmacion()' class='text-light btn btn-danger'>Eliminar <i class='icon ion-md-trash'></i></a>";?></td>
                  </tr>
                    <?php
                    }
                    ?>
