        ...
        <div class="text-dark">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <td><?php echo "<a href='../secciones/vista_EditarHorario.php?idHorario=".$mostrar['IDHorario']."' class='text-light btn btn-success'>Editar <i class='icon ion-md-create'></i></a> ";?></td>
