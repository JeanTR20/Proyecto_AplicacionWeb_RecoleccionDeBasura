                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control ms-3" value="<?php echo $Direccion ?>" name="Direccion" id="Direccion" placeholder="">
                        </div>
                        <div class="mb-3">
                            <label for="Horario" class="form-label"><b>Punto de Recoleccion</b></label>
                            <input type="text"class="form-control ms-3" value="<?php echo $PuntoRecoleccion ?>" name="PuntoRecoleccion" id="PuntoRecoleccion" placeholder="">
                        </div>
                        <div class="mb-3">
                            <input type="hidden" class="form-control ms-3" value="<?php echo $IDPuntoRecoleccion ?>" name="IDPuntoRecoleccion" id="IDPuntoRecoleccion" placeholder="">
                        </div>
