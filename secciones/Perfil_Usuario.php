  ...
  <body>
    <div class= "d-flex">
      <div id= "sidebar-container" class= "bg-primary">
        ...
        <div class= "menu">
            <a href ="../secciones/index.php" class = "d-block text-light p-3"><i class="icon ion-md-home"></i> Inicio</a>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="../secciones/index.php"><i class="icon ion-md-person mr-2 lead"></i>Mi perfil</a>
