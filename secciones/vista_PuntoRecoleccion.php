    ...
    <div class= "d-flex">
      <div id= "sidebar-container" class= "bg-primary">
        ...
        <a href ="#"class = "d-block text-light p-3"><i class="icon ion-md-person mr-2 lead"></i>Perfil</a>
            <a href ="http://localhost:8080/appweb/secciones/vista_Horario.php" class = "d-block text-light p-3"><i class="icon ion-md-calendar mr-2 lead"></i> Horarios</a>
            <a href ="http://localhost:8080/appweb/secciones/vista_PuntoRecoleccion.php"class = "d-block text-light p-3"><i class="icon ion-md-pint mr-2 lead"></i>Punto Recoleccion</a>
        </div>
    </div>
    <div class= "w-100">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#"><i class="icon ion-md-person mr-2 lead"></i>Mi perfil</a>
                <a class="dropdown-item" href="http://localhost:8080/appweb/secciones/salir.php"><i class="icon ion-md-log-out"></i> Cerrar sesion</a>
              </div>
          </ul>
        </div>
      </div>
      ...
      <div id="content">
        <section>
          <div class="container">
            <div class="row">
              <div class="col-lg-9">
                <h1 class="font-weight-bold mb-0 ">PUNTOS DE RECOLECCIÓN DE BASURA</h1>
        ...
        <div class="container text-dark">
            <form action="../secciones/Registro_PuntoRecoleccion.php" method="post">
        ...
        <div class="text-dark">
            <table class="table table-striped">
                <thead>
                    ...
                    <th scope="col">PuntoRecolección</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    $consulta3 = "SELECT * FROM tblpuntorecoleccion";
