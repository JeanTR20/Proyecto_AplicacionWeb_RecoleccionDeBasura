  ...
  <body>
    <div class= "d-flex">
      <div id= "sidebar-container" class= "bg-primary">
        ...
        <div class= "menu">
            <a href ="../secciones/index.php" class = "d-block text-light p-3 btn-outline-success"><i class="icon ion-md-home lead"></i> Inicio</a>
        ...
        <div class="text-dark">
            <table class="table table-striped">
                ...
                <?php
                    ...
                    <td><?php echo "<a href='../secciones/vista_EditarPuntoRecoleccion.php?idPuntoRecoleccion=".$mostrar['IDPuntoRecoleccion']."' class='text-light btn btn-success'>Editar <i class='icon ion-md-create'></i></a> ";?></td>
                    <td><?php echo "<a href='../secciones/Eliminar_PuntoRecoleccion.php?idPuntoRecoleccion=".$mostrar['IDPuntoRecoleccion']."' onclick='return confirmacion()'  class='text-light btn btn-danger'>Eliminar <i class='icon ion-md-trash'></i></a>";?></td>
                    </tr>
                    <?php
                    }
                    ?>
