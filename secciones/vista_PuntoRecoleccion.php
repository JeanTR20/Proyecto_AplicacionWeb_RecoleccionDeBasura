        ...
        <div class="text-dark">
            <table class="table table-striped">
                ...
                <?php
                    ...
                    <td><?php echo "<a href='../secciones/Editar_PuntoRecoleccion.php?idPuntoRecoleccion=".$mostrar['IDPuntoRecoleccion']."' class='text-light btn btn-success'>Editar <i class='icon ion-md-create'></i></a> ";?></td>
