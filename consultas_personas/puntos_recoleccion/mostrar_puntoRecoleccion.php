...
<body>
    ...
    <div class="container">
      ...
      <img src="../../src/img/LOGO.png" class="div-img">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item ms-4">
            <a class="nav-link text-white" href="../../consultas_personas/puntos_recoleccion/mostrar_puntoRecoleccion.php">Consultas de puntos de recolección</a>
          </li>
          <li class="nav-item ms-4">
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="fw-light text-success text-center">PUNTOS DE RECOLECCIÓN DE BASURA</h1>
      <section>
      <div class="text-dark">
