    ...
    <div class= "d-flex">
      <div id= "sidebar-container" class= "bg-primary">
        ...
        <div class= "menu">
            ...
            <a href ="../secciones/Horario/vista_Horario.php" class = "d-block text-light p-3 btn-outline-success"><i class="icon ion-md-calendar mr-2 lead"></i>Horarios</a>
            <a href ="../secciones/PuntoDeRecoleccion/vista_PuntoRecoleccion.php" class = "d-block text-light p-3 btn-outline-success"><i class="icon ion-md-pint mr-2 lead"></i>Punto Recoleccion</a>
        </div>
    </div>
    <div class= "w-100">
